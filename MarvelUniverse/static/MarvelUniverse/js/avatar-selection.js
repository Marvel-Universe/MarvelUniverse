...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.avatar-option').forEach(function (avatarOption) {
        ...
        selectedAvatarContainer.innerHTML = `<img src="${avatarUrl}" alt="Selected Avatar" style="max-width: 150px; max-height: 150px;">`;
    ...
    // Show the fallback SVG in case no avatar is selected
