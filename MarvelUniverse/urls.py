...
from .views.quiz import StartQuizView, CharacterInstructionView, ComicInstructionView, SeriesInstructionView, random_quiz
...
urlpatterns = [
    ...
    # quiz url
    path('quiz/', StartQuizView.as_view(), name='start-quiz'),
    # quiz instruction
